    ...
    <div class="history-list" v-if="history.length">
      ...
      >
        ...
        <div v-if="expandedId === entry.id" class="item-details">
          ...
          <div v-if="entry.stats" class="detail-row">
            <span class="detail-label">Статистика:</span>
            <div class="stats-badges">
              <span v-if="entry.stats.created" class="badge created">+{{ entry.stats.created }}</span>
              <span v-if="entry.stats.updated" class="badge updated">~{{ entry.stats.updated }}</span>
              <span v-if="entry.stats.deleted" class="badge deleted">-{{ entry.stats.deleted }}</span>
              <span v-if="entry.stats.skipped" class="badge skipped">={{ entry.stats.skipped }}</span>
              <span v-if="entry.stats.total" class="badge total">{{ entry.stats.total }} записей</span>
            </div>
          </div>
