...
| Файл | Что изменено |
|------|-------------|
| `netbox/sync/interfaces.py` | Добавлена `_is_lag_interface()`, исправлена сортировка и разделение на фазы, WARNING вместо DEBUG |
...
2. **Не дублировать логику** — один источник правды для алиасов, один для определения LAG
