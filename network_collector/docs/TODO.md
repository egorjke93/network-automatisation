...
### 8. Тестирование (Низкий приоритет)
...
| # | Задача | Оценка | Описание |
|---|--------|--------|----------|
| 7 | Web UI улучшения | 10+ч | Темы, графики, drag-drop |
| 8 | Расширение тестов | 8-10ч | API tests, E2E, coverage |
...
**Проблема:** Обрезка длинных имён (>64 символов) логировалась на DEBUG уровне.

**Решение:** Изменён уровень лога на INFO для видимости при обычном запуске.
