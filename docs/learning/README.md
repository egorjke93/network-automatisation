...
**Итого deep dive:** примерно 2.5-3 часа.

**Рекомендуемый порядок:** 10 → 11 → 12 (doc 10 вводит паттерны, которые используются в doc 11; doc 12 независимый, но ссылается на оба).
